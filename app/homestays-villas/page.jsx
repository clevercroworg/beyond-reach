...
import styles from './HomestaysVillas.module.css';
...
const villaFaqs = [
  {
    ...
    answer: 'We shift the balance of power back to your villa by building a high-converting direct booking ecosystem. This includes optimizing your website for search engines (SEO), running targeted paid media campaigns to capture high-intent travelers, and implementing urgency triggers and rate-parity strategies that incentivize guests to book directly with you rather than a third party.'
  },
  {
    question: 'What digital marketing strategies yield the highest ROI for luxury villas?',
      ...
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroLeft}>
            <span className={styles.heroLabel}>VILLA GROWTH SYSTEM</span>
            <h1 className={styles.heroTitle}>
              MORE DIRECT BOOKINGS<br />
              <span className={styles.glowingText}>FOR VILLAS.</span>
            </h1>
          ...
          <div className={styles.heroRight}>
            <div className={styles.resultsWidget}>
              ...
              <div className={styles.widgetValueGroup}>
                <div className={styles.widgetValue}>+82%</div>
                <div className={styles.widgetSublabel}>Average increase in direct villa bookings</div>
              </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.gridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>WHY VILLAS <br />LOSE DIRECT <br />BOOKINGS.</h2>
            </div>
            ...
            <div className={styles.dashboardContainer}>
                ...
                <div className={styles.dbOverviewStats}>
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>482</span>
                  ...
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$510K</span>
                      <span className={styles.dbStatChangePos}>+42%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Conversion Rate</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>4.12%</span>
                      <span className={styles.dbStatChangePos}>+24%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Avg. Booking Value</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$1,280</span>
              ...
              <div className={styles.dashboardRight}>
                <img
                  ...
                  alt="Luxury villa room view inside dashboard"
                />
              </div>
            </div>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.resultsGridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>Real villas. <br />Real growth.</h2>
            </div>

            <div className={styles.resultsGrid}>
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=400&q=80" alt="The Cliffside Villa" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>THE CLIFFSIDE VILLA</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+88%</div>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=400&q=80" alt="Monterra Suites" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=400&q=80" alt="Pacifica Retreat" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>PACIFICA RETREAT</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+76%</div>
                      <div className={styles.resultStatLbl}>Direct Bookings</div>
                    </div>
                    <div className={styles.resultStatBlock}>
