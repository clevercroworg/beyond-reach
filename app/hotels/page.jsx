...
const processSteps = [
  {
    ...
    desc: "We dive deep into your hotel\u2019s digital presence \u2014 analyzing your current OTA dependency, booking funnels, brand positioning, and competitive landscape to uncover hidden growth levers."
  },
  {
    number: '02',
  ...
  },
  {
    ...
    desc: 'From cinematic videography to immersive virtual tours, we craft visual storytelling that captures the essence of your hotel and compels travelers to book direct.'
  },
  {
    number: '04',
...
const handlePoints = [
  ...
  },
  {
    ...
    desc: "Cinematic content and editorial narratives that position your hotel as the destination, not just accommodation."
  },
  {
    icon: '◈',
        ...
        <div className={styles.headerInner}>
          <div className={styles.headerContent}>
            ...
            <h1 className={styles.headerTitle}>
              <span className={styles.titlePrefix}>We help Hotels with</span>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDesc}>
              A proven five-phase methodology refined across 50+ hotel partnerships worldwide.
            </p>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.handleTop}>
            <div className={styles.handleContent}>
              ...
              <h2 className={styles.handleSectionTitle}>HOW WE HANDLE<br/>HOTEL MARKETING</h2>
