...
import styles from './ToursActivities.module.css';
...
const tourFaqs = [
  {
    question: 'How do you battle global OTAs like Viator and GetYourGuide?',
    answer: 'We run highly localized Google Search and Maps ads targeting tourists already in your area, and offer exclusive direct-booking incentives (e.g. free gear, flexible cancellation) that OTAs cannot match.'
  },
  {
    question: 'Can you optimize our check-out flow to reduce cart abandonment?',
    answer: 'Yes. We optimize your booking engine checkout, integrating digital wallets (Apple Pay, Google Pay) and streamlining form fields to ensure checkout takes under 30 seconds.'
  },
  {
    question: 'Do you integrate with reservation systems like FareHarbor or Peek Pro?',
    answer: 'Yes, we integrate seamlessly with top activity reservation systems, including FareHarbor, Peek Pro, Rezdy, and custom booking APIs.'
  },
  {
    question: 'What content works best to get tour bookings?',
    answer: 'Short-form first-person POV videos on Instagram reels and TikTok showcasing the thrill of the activity, backed by authentic guest review snippets.'
  }
];
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroBg}>
          <img
            ...
            alt="Adventure travelers exploring tours"
          />
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroLeft}>
            <span className={styles.heroLabel}>TOUR OPTIMIZATION SYSTEM</span>
            <h1 className={styles.heroTitle}>
              MORE DIRECT BOOKINGS<br />
              <span className={styles.glowingText}>FOR TOURS.</span>
            </h1>
            <p className={styles.heroSubtitle}>
              Marketing, websites and booking engines drive more direct tour bookings and adventure experiences — sustainably.
            </p>
          ...
          <div className={styles.heroRight}>
            <div className={styles.resultsWidget}>
              ...
              <div className={styles.widgetValueGroup}>
                <div className={styles.widgetValue}>+80%</div>
                <div className={styles.widgetSublabel}>Average increase in direct tour bookings</div>
              </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.gridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>WHY TOURS <br />LOSE BOOKINGS.</h2>
            </div>
            ...
            <div className={styles.cardsCol}>
              <div className={styles.problemCard}>
                ...
                <ProblemWebsiteIcon />
                <h3 className={styles.cardTitle}>CLUTTERED MOBILE EXPERIENCE</h3>
                <p className={styles.cardDesc}>Tours are booked on-the-go; slow mobile sites lose instant buyers.</p>
              </div>

              <div className={styles.problemCard}>
                <span className={styles.problemNum}>02</span>
                <ProblemOtaIcon />
                <h3 className={styles.cardTitle}>EXTREME OTA DOMINANCE</h3>
                <p className={styles.cardDesc}>Paying 20-30% commissions to Viator, GetYourGuide, and TripAdvisor.</p>
              </div>

              <div className={styles.problemCard}>
                <span className={styles.problemNum}>03</span>
                <ProblemInquiryIcon />
                <h3 className={styles.cardTitle}>COMPLEX CHECKOUT FLOWS</h3>
                <p className={styles.cardDesc}>Long forms and slow loading checkout pages increase cart abandonment.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.solutionGridSplit}>
            ...
            <div className={styles.solutionsGrid}>
              <div className={styles.solutionCard}>
                ...
                <SolutionWebsiteIcon />
                <h3 className={styles.solutionCardTitle}>MOBILE-FIRST TOUR PORTALS</h3>
                <p className={styles.solutionCardDesc}>Super fast, clean tour websites designed for mobile booking.</p>
              </div>
              ...
              <div className={styles.solutionCard}>
                ...
                <p className={styles.solutionCardDesc}>Capturing tourists planning trips using local intent search and social.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>03</span>
                <SolutionAutomationIcon />
                <h3 className={styles.solutionCardTitle}>FRICTIONLESS CHECKOUTS</h3>
                <p className={styles.solutionCardDesc}>Instant-booking calendars with secure one-click checkout options.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>04</span>
                <SolutionTrackingIcon />
                <h3 className={styles.solutionCardTitle}>RE-ENGAGEMENT AUTOMATIONS</h3>
                <p className={styles.solutionCardDesc}>Automated review requests, upsells, and next-day tour promos.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.dashboardContainer}>
                ...
                <div className={styles.dbOverviewStats}>
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>2,840</span>
                  ...
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$245K</span>
                      <span className={styles.dbStatChangePos}>+41%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Conversion Rate</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>4.82%</span>
                  ...
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$115</span>
              ...
              <div className={styles.dashboardRight}>
                <img
                  ...
                  alt="Scenic tour activity view inside dashboard"
                />
              </div>
            </div>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.resultsGridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>Real tours. <br />Real growth.</h2>
            </div>

            <div className={styles.resultsGrid}>
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=400&q=80" alt="Safari Adventures" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>SAFARI ADVENTURES</span>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&w=400&q=80" alt="Vortex Tours" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>VORTEX TOURS</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+80%</div>
                      <div className={styles.resultStatLbl}>Direct Bookings</div>
                    </div>
                    <div className={styles.resultStatBlock}>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="Alpine Escapes" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>ALPINE ESCAPES</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+74%</div>
