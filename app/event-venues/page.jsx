...
const venueFaqs = [
  {
    question: 'How do you attract corporate event planners versus wedding couples?',
    answer: 'We build distinct landing page flows and run segmented campaigns: LinkedIn and Google Search ads targeting corporate retreat organizers, alongside highly visual Instagram and Pinterest ads targeting wedding couples.'
  },
  {
    question: 'Can you help automate our RFP (Request for Proposal) responses?',
    answer: 'Yes, we integrate interactive pricing calculators and custom RFP forms that trigger instant personalized pricing emails and push clean lead records directly to your event CRM.'
  },
  {
    question: 'Do you create virtual tours or cinematic site-inspection videos?',
    answer: 'Yes, our team produces high-end virtual walkthroughs and drone-assisted inspection videos so corporate planners can tour the venue digitally.'
  },
  {
    question: 'How long does it take to see an increase in private event inquiries?',
    answer: 'With search and social campaigns optimized for private events, we typically drive a measurable increase in high-quality inquiries within the first 14 to 30 days of launch.'
  }
];
    ...
    <div ref={pageRef} className={styles.pageWrapper}>
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroBg}>
          <img
            src="https://images.unsplash.com/photo-1511556532299-8f662fc26c06?auto=format&fit=crop&w=1600&q=80"
            alt="Premium wedding and private event venue"
          />
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroLeft}>
            <span className={styles.heroLabel}>VENUE GROWTH SYSTEM</span>
            <h1 className={styles.heroTitle}>
              MORE DIRECT BOOKINGS<br />
              <span className={styles.glowingText}>FOR VENUES.</span>
            </h1>
            <p className={styles.heroSubtitle}>
              Marketing, websites and booking engines drive more high-value private and corporate event bookings — sustainably.
            </p>
          ...
          <div className={styles.heroRight}>
            <div className={styles.resultsWidget}>
              ...
              <div className={styles.widgetValueGroup}>
                <div className={styles.widgetValue}>+71%</div>
                <div className={styles.widgetSublabel}>Average increase in direct venue bookings</div>
              </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.gridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>WHY VENUES <br />LOSE BOOKINGS.</h2>
            </div>
            ...
            <div className={styles.cardsCol}>
              <div className={styles.problemCard}>
                ...
                <ProblemWebsiteIcon />
                <h3 className={styles.cardTitle}>POOR VISUAL REPRESENTATION</h3>
                <p className={styles.cardDesc}>Failing to show the grandeur and customizable details of the space online.</p>
              </div>

              <div className={styles.problemCard}>
                <span className={styles.problemNum}>02</span>
                <ProblemOtaIcon />
                <h3 className={styles.cardTitle}>UNSTRUCTURED INQUIRIES</h3>
                <p className={styles.cardDesc}>Cluttered booking forms and slow response times that lose premium event hosts.</p>
              </div>

              <div className={styles.problemCard}>
                <span className={styles.problemNum}>03</span>
                <ProblemInquiryIcon />
                <h3 className={styles.cardTitle}>COMMISSION-HEAVY DIRECTORIES</h3>
                <p className={styles.cardDesc}>Paying hefty commissions to wedding and event directories for leads.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.solutionGridSplit}>
            ...
            <div className={styles.solutionsGrid}>
              <div className={styles.solutionCard}>
                ...
                <SolutionWebsiteIcon />
                <h3 className={styles.solutionCardTitle}>IMMERSIVE DIGITAL SHOWCASES</h3>
                <p className={styles.solutionCardDesc}>Beautiful, fast sites featuring virtual tours and event galleries.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>02</span>
                <SolutionAdIcon />
                <h3 className={styles.solutionCardTitle}>TARGETED ADVERTISING & SEO</h3>
                <p className={styles.solutionCardDesc}>Reaching wedding couples and corporate event planners at planning stages.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>03</span>
                <SolutionAutomationIcon />
                <h3 className={styles.solutionCardTitle}>INTERACTIVE RFQ ENGINES</h3>
                <p className={styles.solutionCardDesc}>Frictionless RFP submission and automated proposal builders.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>04</span>
                <SolutionTrackingIcon />
                <h3 className={styles.solutionCardTitle}>EVENT SALES AUTOMATION</h3>
                <p className={styles.solutionCardDesc}>Automated lead tracking and CRM follow-ups to close events faster.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.dashboardContainer}>
                ...
                <div className={styles.dbOverviewStats}>
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>412</span>
                      <span className={styles.dbStatChangePos}>+25%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Revenue</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$890K</span>
                      <span className={styles.dbStatChangePos}>+38%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Conversion Rate</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>5.12%</span>
                      <span className={styles.dbStatChangePos}>+20%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Avg. Booking Value</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$2,160</span>
                      <span className={styles.dbStatChangePos}>+15%</span>
                    </div>
                  </div>
                </div>
              ...
              <div className={styles.dashboardRight}>
                <img
                  ...
                  alt="Premium wedding setup view inside dashboard"
                />
              </div>
            </div>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.resultsGridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>Real venues. <br />Real growth.</h2>
            </div>

            <div className={styles.resultsGrid}>
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&w=400&q=80" alt="The Grand Pavilion" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>THE GRAND PAVILION</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+54%</div>
                      <div className={styles.resultStatLbl}>Direct Bookings</div>
                    </div>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+32%</div>
                      <div className={styles.resultStatLbl}>RFP Value</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?auto=format&fit=crop&w=400&q=80" alt="Vista Terrace" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>VISTA TERRACE</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+71%</div>
                      <div className={styles.resultStatLbl}>Direct Bookings</div>
                    </div>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+46%</div>
                      <div className={styles.resultStatLbl}>Ad Revenue</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=400&q=80" alt="The Glass House" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>THE GLASS HOUSE</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+65%</div>
                      <div className={styles.resultStatLbl}>Lead Flow</div>
                    </div>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+29%</div>
                      <div className={styles.resultStatLbl}>Booking Yields</div>
                    </div>
                  </div>
                </div>
              </div>
