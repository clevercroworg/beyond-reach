...
const processSteps = [
  {
    ...
    desc: "We dive deep into your venue\u2019s digital presence \u2014 analyzing your current OTA dependency, booking funnels, brand positioning, and competitive landscape to uncover hidden growth levers."
  },
  {
    number: '02',
  ...
  },
  {
    ...
    desc: 'From cinematic videography to immersive virtual tours, we craft visual storytelling that captures the essence of your venue and compels travelers to book direct.'
  },
  {
    number: '04',
...
const handlePoints = [
  ...
  },
  {
    ...
    desc: "Cinematic content and editorial narratives that position your venue as the destination, not just accommodation."
  },
  {
    icon: '◈',
...
const venueFaqs = [
  {
    ...
    answer: 'We shift the balance of power back to your venue by building a high-converting direct booking ecosystem. This includes optimizing your website for search engines (SEO), running targeted paid media campaigns to capture high-intent travelers, and implementing urgency triggers and rate-parity strategies that incentivize guests to book directly with you rather than a third party.'
  },
  {
    question: 'What digital marketing strategies yield the highest ROI for luxury venues?',
        ...
        <div className={styles.headerInner}>
          <div className={styles.headerContent}>
            ...
            <h1 className={styles.headerTitle}>
              <span className={styles.titlePrefix}>We help Venues with</span>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionDesc}>
              A proven five-phase methodology refined across 50+ venue partnerships worldwide.
            </p>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.handleTop}>
            <div className={styles.handleContent}>
              ...
              <h2 className={styles.handleSectionTitle}>HOW WE HANDLE<br/>VENUE MARKETING</h2>
