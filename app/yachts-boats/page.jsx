...
import styles from './YachtsBoats.module.css';
...
const charterFaqs = [
  {
    question: 'How do you target wealthy individuals for charter bookings?',
    answer: 'We run high-affinity targeting campaigns on Meta and Google Search, aiming for yachting enthusiasts, golf club members, and luxury travelers in affluent locations.'
  },
  {
    question: 'Can you build a booking engine that supports dynamic yacht charter pricing?',
    answer: 'Yes. We design custom reservation flows that calculate charter pricing based on duration, crew requirements, catering options, and seasonal rates.'
  },
  {
    question: 'Do you produce video tours and drone shots for yachts?',
    answer: 'Yes, our luxury media team shoots high-end 4K drone videography, lifestyle walkthroughs, and technical detail shots to show the yacht in its best light.'
  },
  {
    question: 'Can you help promote corporate events and private parties on yachts?',
    answer: 'Yes, we create dedicated landing pages and ad funnels targeting corporate planners and wedding planners looking for a unique venue.'
  }
];
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroBg}>
          <img
            ...
            alt="Luxury yacht on pristine ocean waters"
          />
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroLeft}>
            <span className={styles.heroLabel}>YACHT GROWTH SYSTEM</span>
            <h1 className={styles.heroTitle}>
              MORE DIRECT BOOKINGS<br />
              <span className={styles.glowingText}>FOR CHARTERS.</span>
            </h1>
            <p className={styles.heroSubtitle}>
              Marketing, websites and booking engines drive more direct luxury yacht charters and boat bookings — sustainably.
            </p>
          ...
          <div className={styles.heroRight}>
            <div className={styles.resultsWidget}>
              <div className={styles.widgetHeader}>
                ...
                <span className={styles.widgetLabel}>Direct charters increase</span>
              </div>
              <div className={styles.widgetValueGroup}>
                <div className={styles.widgetValue}>+62%</div>
                <div className={styles.widgetSublabel}>Average increase in direct charters</div>
              </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.gridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>WHY CHARTERS <br />LOSE BOOKINGS.</h2>
            </div>
            ...
            <div className={styles.cardsCol}>
              <div className={styles.problemCard}>
                ...
                <p className={styles.cardDesc}>Slow sites, unoptimized booking paths, and lack of visual prestige.</p>
              </div>

              <div className={styles.problemCard}>
                <span className={styles.problemNum}>02</span>
                <ProblemOtaIcon />
                <h3 className={styles.cardTitle}>COMMISSION-HEAVY OTA BROKERS</h3>
                <p className={styles.cardDesc}>Losing 15-25% margin to charter agencies and third-party brokers.</p>
              </div>
              ...
              <div className={styles.problemCard}>
                ...
                <p className={styles.cardDesc}>Unstructured inquiry forms and slow follow-ups that cause high-value leads to book elsewhere.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.solutionGridSplit}>
            ...
            <div className={styles.solutionsGrid}>
              <div className={styles.solutionCard}>
                ...
                <SolutionWebsiteIcon />
                <h3 className={styles.solutionCardTitle}>PRESTIGIOUS DIGITAL SHOWCASES</h3>
                <p className={styles.solutionCardDesc}>Beautiful, fast sites featuring virtual tours, layout specs, and onboard amenities.</p>
              </div>
              ...
              <div className={styles.solutionCard}>
                ...
                <p className={styles.solutionCardDesc}>Targeting luxury wellness seekers and corporate planners on search and social.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>03</span>
                <SolutionAutomationIcon />
                <h3 className={styles.solutionCardTitle}>INTERACTIVE BOOKING ENGINE</h3>
                <p className={styles.solutionCardDesc}>Frictionless check-out or customized reservation inquiries that capture leads.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>04</span>
                <SolutionTrackingIcon />
                <h3 className={styles.solutionCardTitle}>RETENTION & MEMBER CAMPAIGNS</h3>
                <p className={styles.solutionCardDesc}>Automated seasonal newsletters and VIP loyalty programs.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.dashboardContainer}>
                ...
                <div className={styles.dbOverviewStats}>
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>324</span>
                      <span className={styles.dbStatChangePos}>+22%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Revenue</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$940K</span>
                      <span className={styles.dbStatChangePos}>+35%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Conversion Rate</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>3.15%</span>
                  ...
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$4,250</span>
              ...
              <div className={styles.dashboardRight}>
                <img
                  ...
                  alt="Luxury yacht cockpit view inside dashboard"
                />
              </div>
            </div>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.resultsGridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>Real charters. <br />Real growth.</h2>
            </div>

            <div className={styles.resultsGrid}>
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?auto=format&fit=crop&w=400&q=80" alt="Azure Charters" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>AZURE CHARTERS</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+58%</div>
                      <div className={styles.resultStatLbl}>Direct Charters</div>
                    </div>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+31%</div>
                      <div className={styles.resultStatLbl}>Net Profits</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1559136555-9303baea8ebd?auto=format&fit=crop&w=400&q=80" alt="Monterey Boat Rentals" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>MONTEREY RENTALS</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=400&q=80" alt="Pacifica Cruise Co." className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>PACIFICA CRUISE CO.</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
