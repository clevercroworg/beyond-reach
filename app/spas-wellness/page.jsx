...
import styles from './SpasWellness.module.css';
...
const spaFaqs = [
  {
    question: 'How do you integrate with our existing spa scheduling software?',
    answer: 'We integrate seamlessly with leading spa management platforms like Mindbody, Zenoti, Booker, and custom booking software, ensuring real-time availability and frictionless checkouts.'
  },
  {
    question: 'What paid advertising channels work best for luxury wellness spas?',
    answer: 'Meta Ads (Instagram and Facebook) are highly effective for visual storytelling, while Google Search and Google Maps ads capture local high-intent customers searching for wellness and spa experiences in real-time.'
  },
  {
    question: 'Can you help promote our retail product line along with treatments?',
    answer: 'Yes. We build integrated e-commerce funnels that allow guests to purchase spa products, gift cards, and membership programs directly from your site, maximizing average guest value.'
  },
  {
    question: 'Do you produce the photo and video assets?',
    answer: 'Yes, our production team captures high-definition cinematic video, lifestyle photography, and calming walkthroughs to showcase the premium sensory experience of your sanctuary.'
  }
];
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroBg}>
          <img
            ...
            alt="Luxury wellness spa environment"
          />
        ...
        <div className={styles.heroInner}>
          <div className={styles.heroLeft}>
            <span className={styles.heroLabel}>SPA GROWTH SYSTEM</span>
            <h1 className={styles.heroTitle}>
              MORE DIRECT BOOKINGS<br />
              <span className={styles.glowingText}>FOR SPAS.</span>
            </h1>
            <p className={styles.heroSubtitle}>
              Marketing, websites and booking engines drive more direct revenue — sustainably.
            </p>
          ...
          <div className={styles.heroRight}>
            <div className={styles.resultsWidget}>
              ...
              <div className={styles.widgetValueGroup}>
                <div className={styles.widgetValue}>+64%</div>
                <div className={styles.widgetSublabel}>Average increase in direct spa bookings</div>
              </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.gridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>WHY SPAS <br />LOSE DIRECT <br />BOOKINGS.</h2>
            </div>
            ...
            <div className={styles.cardsCol}>
              <div className={styles.problemCard}>
                ...
                <ProblemWebsiteIcon />
                <h3 className={styles.cardTitle}>POOR VISUAL EXPERIENCE</h3>
                <p className={styles.cardDesc}>Slow, cluttered sites that fail to convey the sensory luxury of the sanctuary.</p>
              </div>

              <div className={styles.problemCard}>
                <span className={styles.problemNum}>02</span>
                <ProblemOtaIcon />
                <h3 className={styles.cardTitle}>COMMISSION-HEAVY OTA BOOKINGS</h3>
                <p className={styles.cardDesc}>Losing 15-20% margin to third-party booking platforms.</p>
              </div>

              <div className={styles.problemCard}>
                <span className={styles.problemNum}>03</span>
                <ProblemInquiryIcon />
                <h3 className={styles.cardTitle}>INCOMPATIBLE SCHEDULING FLOW</h3>
                <p className={styles.cardDesc}>Complex booking systems that frustrate guests trying to book packages.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.solutionGridSplit}>
            ...
            <div className={styles.solutionsGrid}>
              <div className={styles.solutionCard}>
                ...
                <SolutionWebsiteIcon />
                <h3 className={styles.solutionCardTitle}>SENSORY DIGITAL EXPERIENCES</h3>
                <p className={styles.solutionCardDesc}>Beautiful, fast websites that evoke wellness and peace.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>02</span>
                <SolutionAdIcon />
                <h3 className={styles.solutionCardTitle}>PAID ADVERTISING & SEO</h3>
                <p className={styles.solutionCardDesc}>Targeting luxury wellness seekers on Google and Meta search.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>03</span>
                <SolutionAutomationIcon />
                <h3 className={styles.solutionCardTitle}>INTEGRATED BOOKING SYSTEM</h3>
                <p className={styles.solutionCardDesc}>Frictionless package and therapy booking systems that convert.</p>
              </div>

              <div className={styles.solutionCard}>
                <span className={styles.solutionNum}>04</span>
                <SolutionTrackingIcon />
                <h3 className={styles.solutionCardTitle}>RETENTION & GUEST LOYALTY</h3>
                <p className={styles.solutionCardDesc}>Automated email and loyalty flows that bring guests back.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.dashboardContainer}>
                ...
                <div className={styles.dbOverviewStats}>
                  <div className={styles.dbStatBlock}>
                    ...
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>1,420</span>
                      <span className={styles.dbStatChangePos}>+21%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Revenue</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$380K</span>
                      <span className={styles.dbStatChangePos}>+34%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Conversion Rate</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>4.15%</span>
                      <span className={styles.dbStatChangePos}>+19%</span>
                    </div>
                  </div>
                  <div className={styles.dbStatBlock}>
                    <span className={styles.dbStatLabel}>Avg. Booking Value</span>
                    <div className={styles.dbStatValGroup}>
                      <span className={styles.dbStatValue}>$268</span>
              ...
              <div className={styles.dashboardRight}>
                <img
                  ...
                  alt="Luxury spa reception area view inside dashboard"
                />
              </div>
            </div>
          </div>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.resultsGridSplit}>
            <div className={styles.stickyCol}>
              ...
              <h2 className={styles.splitSectionTitle}>Real wellness. <br />Real growth.</h2>
            </div>

            <div className={styles.resultsGrid}>
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=400&q=80" alt="Ananda Sanctuary" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>ANANDA SANCTUARY</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+48%</div>
                      <div className={styles.resultStatLbl}>Direct Bookings</div>
                    </div>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+28%</div>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&w=400&q=80" alt="Vitality Resort Spa" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>VITALITY RESORT SPA</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+62%</div>
                      <div className={styles.resultStatLbl}>Direct Bookings</div>
                    </div>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+39%</div>
                      <div className={styles.resultStatLbl}>Direct Revenue</div>
                    </div>
                  </div>
                </div>
              ...
              <div className={styles.resultsCard}>
                <img src="https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?auto=format&fit=crop&w=400&q=80" alt="Elysian Wellness" className={styles.resultsCardBgImg} />
                <div className={styles.resultsCardOverlay}></div>
                <div className={styles.resultsCardContent}>
                  <span className={styles.resultHotelName}>ELYSIAN WELLNESS</span>
                  <div className={styles.resultStatGroup}>
                    <div className={styles.resultStatBlock}>
                      <div className={styles.resultStatVal}>+55%</div>
                      <div className={styles.resultStatLbl}>Direct Bookings</div>
                    </div>
                    <div className={styles.resultStatBlock}>
