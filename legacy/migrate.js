...
if (fs.existsSync(layoutPath)) {
  ...
  if (!layoutContent.includes('Navbar')) {
    ...
    // We need state for Menu in Layout, but Layout is a Server Component in Next.js by default.
    // Instead of forcing layout to be client, we will create a ClientWrapper.
  }
}
